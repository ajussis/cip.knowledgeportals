...
PRODUCT_DEPENDENCIES = ('collective.googleanalytics','Products.CacheSetup','raptus.multilanguageplone',
                        'raptus.multilanguagefields','plone.contentratings','borg.project')
EXTENSION_PROFILES = ('cip.sppolicy:default',)
