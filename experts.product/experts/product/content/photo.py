...
PhotoSchema['description'].widget.visible['view'] = 'invisible'
PhotoSchema['description'].widget.visible['edit'] = 'invisible'
...
# Reorder fields
PhotoSchema.moveField("comments", after="image")
PhotoSchema.moveField("caption", after="title")
